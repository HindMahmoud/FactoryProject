<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Home.master" CodeFile="recycle.aspx.cs" Inherits="recycle" %>
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
              <% 
                  ...
                  var x = (from s in db.destroy_inv where s.stat == 0 &&s.roleType==roleType&&s.inv_id==id select s).OrderBy(a=>a.prod_name).ToList();
       %>
            <thead>
            ...
            <tr>
              ...
              <td><a  href="recycle.aspx?edititem=<%=item.id %>">  <i class="fa fa-edit "></i></a>
               <a href="recycle.aspx?delitem=<%=item.id %>">  <i class="fa fa-trash-o text-red"></i></a></td>
            </tr>
                 <%i++;
                         }
                     } %>
